        ...
        <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
          ...
          <div className="flex justify-center items-center gap-4">
            <button
              ...
              className='flex w-3/4 cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50 '
            >
            ...
            <button onClick={handleGithibSignIn} className='py-3 w-1/4 flex cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50'>
