      ...
      <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl '>
        ...
        <div className='w-full px-6 py-8 md:px-8 lg:w-1/2'>
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-0 lg:gap-4">
            ...
            <button onClick={handleGithubSignIn} className='py-3 w-full lg:w-1/4 flex cursor-pointer items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg hover:bg-gray-50'>
